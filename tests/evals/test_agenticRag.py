...
@pytest.mark.evaluation
@pytest.mark.usefixtures("evaluation_setup")
def test_policies_001_negative(agentic_rag_summary):
    """
...
# @pytest.mark.evaluation
# @pytest.mark.usefixtures("evaluation_setup")
# def test_metric_greater_than(agentic_rag_summary):
#     """
#     For demonstration, check that in the case 'agentic-rag-policies-001-positive.v0',
#     the FuzzyEvaluator.indel_similarity is at least 90.
#     """
#     check_case_metric(
#         summary=agentic_rag_summary,
...
# @pytest.mark.evaluation
# @pytest.mark.usefixtures("evaluation_setup")
# def test_metric_less_than(agentic_rag_summary):
#     """
#     For demonstration, check that in the case 'agentic-rag-reasoning-001-positive.v0',
#     the FuzzyEvaluator.indel_similarity is less than or equal to 110.
#     """
#     check_case_metric(
#         summary=agentic_rag_summary,
